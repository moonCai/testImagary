...
import { wmsUrl, googleOfflineUrl } from '../../request/env.js'
 ...
 */
export function defaultInitCesium(id, mapType, isImage, options, completionByDefaultOptions) {
    ...
    } else if (mapType == 'google-offline') {
        imageryProvider = getGoogleOfflineProvider();
    }
...
// google offline
function getGoogleOfflineProvider() {
    return new Cesium.UrlTemplateImageryProvider({
      url: googleOfflineUrl
    });
  }
...
function getWMSImageProvider() {
    return  new Cesium.WebMapServiceImageryProvider({
        url: wmsUrl,
        layers: 'global:global_vec_500_m',
        parameters: {
            service: 'WMS',
            format: 'image/jpeg',
            srs: 'EPSG:4326'
